...
export const MapControls: React.FC<MapControlsProps> = ({ isFullscreen, onToggleFullscreen }) => {
    return (
        <Controls
            position="bottom-right"
            showInteractive={false}
            className="!bg-white dark:!bg-gray-800 !border-gray-200 dark:!border-gray-700 !shadow-md !m-4"
        >
            <ControlButton
