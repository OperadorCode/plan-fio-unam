...
import { X, Download, MousePointer2, Save, Sparkles, ArrowRight } from 'lucide-react';
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    >
                        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white text-center relative overflow-hidden">
                            ...
                            <h2 className="text-2xl font-bold">¡Bienvenido al Planificador!</h2>
                            <p className="text-blue-100 text-sm mt-1">Gestión de cursada y correlatividades</p>
