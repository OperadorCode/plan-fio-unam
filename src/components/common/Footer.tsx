 ...
 * - Acciones rápidas (sugerencias, reporte de errores).
 * - Créditos, versión y enlaces a código fuente y sitio oficial.
 *
 * @returns JSX.Element
 */
const PROJECT_URLS = {
                ...
                <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
                    ...
                    >
                        <img
                            ...
                            alt="Logo CEFI"
                            className="h-10 sm:h-16 w-auto object-contain mix-blend-multiply dark:mix-blend-normal dark:rounded-md"
                        />
                    </a>
                    {/* JUP */}
                    <a
            ...
            <div className="bg-gray-50 dark:bg-gray-950 border-t border-gray-100 dark:border-gray-800 transition-colors duration-300">
                <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <div className="flex items-center gap-4">
                        <span className="font-semibold text-gray-400 dark:text-gray-500">Planificador Académico FIO <span className="ml-1 px-1.5 py-0.5 bg-gray-200 dark:bg-gray-800 text-gray-600 dark:text-gray-300 rounded text-[10px]">V1.0</span></span>
                        <div className="h-3 w-px bg-gray-300 dark:bg-gray-700 mx-2 hidden md:block"></div>
                        <div className="flex items-center gap-3">
                            <a href={PROJECT_URLS.source} target="_blank" rel="noreferrer" className="hover:text-black dark:hover:text-white transition-colors" title="Código Fuente en GitHub">
                                <Github className="h-4 w-4" />
                            </a>
                            <a href="https://www.fio.unam.edu.ar" target="_blank" rel="noreferrer" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors" title="Sitio Oficial FIO">
