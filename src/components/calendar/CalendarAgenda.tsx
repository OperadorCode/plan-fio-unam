            ...
            <div className="space-y-2 mb-4 max-h-48 overflow-y-auto pr-1 custom-scrollbar">
                {eventsForDay.length > 0 ? (
                    eventsForDay.map((ev, idx) => (
                        <div key={idx} className={`group pl-3 border-l-4 ${BORDER_COLORS[ev.type]} bg-white dark:bg-gray-800 p-2 rounded-r-md shadow-sm text-sm flex justify-between items-start transition-all hover:shadow-md`}>
                            <div>
