...
export const CalendarHeader = memo(({ monthName, year, viewMode, onViewChange, onPrevMonth, onNextMonth, onGoToday }: CalendarHeaderProps) => {
    return (
            ...
            <div className="flex items-center gap-3">
                <div className="flex bg-gray-100 dark:bg-gray-700 p-0.5 rounded-lg">
                    <button
                        ...
                        className={`p-1.5 rounded-md transition-all ${viewMode === 'grid' ? 'bg-white dark:bg-gray-600 shadow-sm text-blue-600 dark:text-blue-400' : 'text-gray-400 hover:text-gray-600 dark:hover:text-gray-300'}`}
                        title="Vista Mensual"
                    ...
                    <button
                        ...
                        className={`p-1.5 rounded-md transition-all ${viewMode === 'list' ? 'bg-white dark:bg-gray-600 shadow-sm text-blue-600 dark:text-blue-400' : 'text-gray-400 hover:text-gray-600 dark:hover:text-gray-300'}`}
